import bge
from getDayOfWeekName import getDayOfWeekName
...
def on_click():
    ...
    if mouse_over_sensor.positive and mouse_click_sensor.positive:
        ...
        date_object = theScene.objects.get('dayOfWeekName')
        
        if date_object:
            # Change the Text property of the text object
            theScene.objects['dayOfWeekName']['Text'] = f"{getDayOfWeekName()}"
        else:
            print("Text object named 'dayOfWeekName' not found.")
