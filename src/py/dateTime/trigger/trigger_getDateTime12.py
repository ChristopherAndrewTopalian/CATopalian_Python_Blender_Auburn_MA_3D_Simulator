import bge
from getDateTime12 import getDateTime12
...
def on_click():
    ...
    if mouse_over_sensor.positive and mouse_click_sensor.positive:
        ...
        date_object = theScene.objects.get('dateTime12')
        
        if date_object:
            # Change the Text property of the text object
            theScene.objects['dateTime12']['Text'] = f"{getDateTime12()}"
        else:
            print("Text object named 'dateTime12' not found.")
